...
<header>
  ...
  <div class="logo" >
    <a href="index.php"><img src="assets/images/logo_eco.png" style="width: 150px; height: 60px; border-radius: 10px; " alt="image"/></a>
  </div>
</div>
        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">AyoubSAGHRO@27gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Service Helpline Call Us: </p>
              <a href="tel:61-1234-5678-09">+212708545164</a> </div>
